...
import 'package:remote_kitchen_test/Services/Local%20DB/folder.dart';
...
class DatabaseHelper  {
  ...
  void _createDb(Database db, int newVersion) async {
    await db.execute('CREATE TABLE IF NOT EXISTS itemsTable( primeKey INTEGER PRIMARY KEY AUTOINCREMENT, itemId TEXT, itemImageUrl TEXT, itemName TEXT, itemDescription TEXT, itemQuantity TEXT , itemBasePrice TEXT, itemTotalPrice TEXT)');
  }
